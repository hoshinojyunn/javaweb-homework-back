 ...
 * <p><strong>登录检查API{@link #loginCheck(HttpServletRequest, User)}</strong></p>
 * <p><strong>一般操作检查API{@link #check(HttpSession)}</strong></p>
 * <p><strong>用户头像获取API{@link #getAvatar(HttpSession)}</strong></p>
 * @author hoshino
 * @version 1.4
 */
@RestController
